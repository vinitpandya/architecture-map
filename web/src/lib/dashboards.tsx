...
/** Remembers the page last opened so /pages can land somewhere sensible. */
export const ACTIVE_KEY = 'architecture-map.page'
...
export function DashboardsProvider({ children }: { children: ReactNode }) {
  ...
  const create = useCallback(
    async (name: string, withStarter: boolean) => {
      // The server owns the default layout, so it stays configurable.
